...
class ClassifierVisualizer():
    ...
    #   - device: デバイスオブジェクト（cpu, cuda:0, cuda:1, etc.）
    ...
    def show(self, model, device, class_colors, samples=None, title=None, hlabel=None, vlabel=None, clabels=None, bins=None):
        ...
        if samples is not None:
            ...
            self.ax.legend(loc='best')#'upper left')
